    ...
    return (
        ...
        <ScrollAnimation animateIn='slideInLeft' initiallyVisible={false} animateOnce={true} duration={1}>
            ...
            <div className="about-me-text">
                ...
                web development and UI/UX. I love to build apps that are not only visually stimulating but also highly user friendly. I also hold three degrees in philosophy, political science and my MS in Database Administration.
            </div>
