...
function Card() {
    ...
    const Data = [
        ...
        },
        {
            ...
            "modalBody": "The above video highlights some of the key features I've worked on within UHOne Shop, these include the compare tool, add to cart highlight feature, chat animations, ACA Landing page, and much more.",
